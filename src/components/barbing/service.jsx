    ...
    <div className="w-full md:pr-32 md:pl-32 pl-14 pr-14 md:mt-20 mt-14  " >
      <div className="flex items-center md:flex-row flex-col w-full justify-between mb-14 md:mb-32   ">
        <div className="md:w-[45%] mb-5 md:mb-0 md:h-[50dvh] w-full ">
          <img src={Imagebarb1} alt="" className="w-full md:h-full h-[30dvh]" data-aos="fade-in" />
        </div>

        <div className="md:w-[50%] md:h-[50dvh] w-full">
          <p className="text-white w-full md:text-[36px] text-[41px] font-800 mb-5" data-aos="fade-in">
          ...
          <div className=" flex flex-col md:flex-row w-full  justify-between ">
            ...
            <p className="text-white text-[20px] w-[80%] h-[20%]" data-aos="fade-in">
      ...
      <div className="flex items-center md:flex-row flex-col-reverse w-full justify-between mb-14 md:mb-32   ">
        ...
        <div className="md:w-[45%] mb-5 md:mb-0 md:h-[50dvh] w-full ">
          <img src={Imagebarb3} alt="" className="w-full md:h-full h-[30dvh]" data-aos="fade-in" />
        </div>
      </div>

      <div className="flex items-center md:flex-row flex-col w-full justify-between mb-10   ">
        <div className="md:w-[45%] mb-5 md:mb-0 md:h-[50dvh] w-full ">
          <img src={Imagebarb2} alt="" className="w-full md:h-full h-[30dvh]" data-aos="fade-in" />
        </div>
